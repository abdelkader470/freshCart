...
export default function Cart() {
  ...
  let { getCart, removeCatItem, updateCarItem, deleteAllCart, totalPrice } =
          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              ...
              <tr className="bg-white text-center font-extrabold border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td className="font-extrabold text-black text-xl py-5">
                  Total Price
                </td>
                <td className="font-bold py-5 text-black text-xl" colSpan="3">
                  {totalPrice} EGP
                </td>
                ...
                <td className="font-bold py-5 text-black text-xl" colSpan="1">
                  <button
                    className="bg-red-700 text-white px-3 py-2 rounded-xl my-3"
                    onClick={() => deleteAll()}
                  >
                    Clear Cart
                  </button>
